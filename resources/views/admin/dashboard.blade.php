...
@section('content')
<section>
    <div class="mt-5 card-group" style="background-color: #254038;">
        <div class="d-md-flex justify-content-sm-center align-items-sm-center flex-lg-row flex-md-column">
            ...
            <div class="d-md-flex justify-content-sm-center align-items-sm-center flex-lg-row flex-md-column">
                ...
                <div class="d-flex mb-4">
                    <div class="mx-2">
                        <img src="{{ asset('assets/rupiah.png') }}" class="img" style="width: 80px; height: auto !important;">
                    </div>
                    <div id="text1">
        ...
        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100 h-auto" src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(22).webp" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 h-auto" src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(15).webp" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 h-auto" src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(23).webp" alt="Third slide">
                </div>
            </div>
